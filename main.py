...
def enter_data():
    ...
    if accepted == "Accepted":
        ...
        if firstname and lastname:
            ...
            reg_no = firstname[:3] + phone[5:] + gender[0:1]
...
# Consent
consent_frame = tkinter.LabelFrame(frame, text="Informed Consent")
consent_frame.grid(row=4, column=0, sticky="news", padx=20, pady=10)

accept_var = tkinter.StringVar(value="Not Accepted")
terms_check = tkinter.Checkbutton(consent_frame, text="I hereby state that the treatment procedures to be carried out have been explained to me and I give my consent",
