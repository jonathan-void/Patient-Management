...
def enter_data():
    ...
    if accepted == "Accepted":
        ...
        if firstname and lastname:
            ...
            patient_folder = os.path.join(desktop_path, "Patient Files")
            os.makedirs(patient_folder, exist_ok=True)

            patient_file = os.path.join(patient_folder, file_name)
...
gender_label: Label = tkinter.Label(user_info_frame, text="Gender")
...
bp_check = tkinter.Checkbutton(medical_frame, text="Blood Pressure",variable=bp_status_var, onvalue="Blood Pressure", offvalue="NIL")
...
diabetes_check = tkinter.Checkbutton(medical_frame, text="Diabetes", variable=diabetes_status_var, onvalue="Diabetes", offvalue="NIL")
...
cardiac_check = tkinter.Checkbutton(medical_frame, text="Cardiac Problems", variable=cardiac_status_var, onvalue="Cardiac Problems", offvalue="NIL")
...
pregnant_label = tkinter.Label(medical_frame, text="Are You Pregnant?")
pregnant_label.grid(row=0, column=5)
pregnant_
...
current_medicines_label = tkinter.Label(extra_frame, text="Current Medications")
...
allergies_enter = ttk.Combobox(extra_frame, values=["Penicillin", "Sulfa", "Aspirin", "Local Anaesthetic"])
allergies_enter.grid(row=1, column=1)

habits_label = tkinter.Label(extra_frame, text="Habits")
habits_label.grid(row=0, column=2)
habits_enter = ttk.Combobox(extra_frame, values=["Tobacco chewing", "Smoking", "Alchoholic"])
